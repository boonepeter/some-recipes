...
userRouter.get('/', function (_req, response) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, UserSchema_1.default.find({}).populate('lists', {
                    title: 1,
                    id: 1,
                    recipes: 1,
                    user: 1
...
userRouter.get('/:id', function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, UserSchema_1.default.findOne({ username: request.params.id }).populate('lists', {
                    title: 1,
                    id: 1,
                    recipes: 1,
                    user: 1
