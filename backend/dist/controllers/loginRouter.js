...
loginRouter.post('/', function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var body, user, passwordCorrect, userForToken, token;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                body = request.body;
                return [4 /*yield*/, UserSchema_1.default.findOne({ email: body.email }).populate({ path: 'lists', populate: { path: 'recipes' } })];
            case 1:
                user = _a.sent();
                if (user === null) {
                ...
                return [4 /*yield*/, bcryptjs_1.default.compare(body.password, user.passwordHash)];
            case 2:
                ...
                response
                    .status(200)
                    .json({ token: token, user: user === null || user === void 0 ? void 0 : user.toJSON() });
                _a.label = 3;
